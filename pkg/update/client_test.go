...
func TestCanParseUpdateCentre_Deprecations(t *testing.T) {
	...
	client := api.NewClient(api.ReplaceTripper(http))
	u.SetClient(client)
	http.StubWithFixture(200, "uc.deprecated.json")
...
func TestCanParseUpdateCentre_SecurityUpdates_NoVulnerability(t *testing.T) {
	u := update.Updater{}
...
func TestCanParseUpdateCentre_SecurityUpdates(t *testing.T) {
	u := update.Updater{}
	...
	http.StubWithFixture(200, "uc.security-update.json")
